...
In addition to the applied side of emissivity measurements, I find the more fundamental spectroscopic side of it fascinating. This was the topic I specialized in during my postdoctoral position. As examples of this methodology, I have published papers on the [optical conductivity of rutile at high temperatures](https://doi.org/10.1063/5.0056081) and a novel approach to study the lattice dynamics of oxide nanoparticles ([cerium oxide](https://doi.org/10.1039/D1CP01259B) and [aluminum oxide](https://doi.org/10.1016/j.saa.2023.122795)). I have also researched the infrared response of metallic materials, including subtle phenomena such as the [anomalous skin effect of noble metals](https://doi.org/10.1140/epjp/s13360-024-05819-3). Finally, I have also been involved in less conventional spectroscopic problems tackled using emissivity measurements, such as the study of [corrosion processes](https://doi.org/10.1016/j.corsci.2020.108723).
